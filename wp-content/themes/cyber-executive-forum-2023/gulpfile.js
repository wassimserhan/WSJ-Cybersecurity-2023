...
gulp.task('browser-sync', function () {
  bs.init({
    proxy: 'http://localhost:8888/websites/cyber-executive-forum-2023/', // We need to use a proxy instead of the built-in server because WordPress has to do some server-side rendering for the theme to work
    watchOptions: {
